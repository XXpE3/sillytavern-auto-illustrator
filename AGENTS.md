...
This project is indexed by GitNexus as **sillytavern-auto-illustrator** (3101 symbols, 7040 relationships, 265 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/sillytavern-auto-illustrator/context` | Codebase overview, check index freshness |
| `gitnexus://repo/sillytavern-auto-illustrator/clusters` | All functional areas |
| `gitnexus://repo/sillytavern-auto-illustrator/processes` | All execution flows |
| `gitnexus://repo/sillytavern-auto-illustrator/process/{name}` | Step-by-step execution trace |
